...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="其他" tabindex="-1"><a class="header-anchor" href="#其他" aria-hidden="true">#</a> 其他</h2><p>cobra 提供了非常丰富的特性和定制化接口，例如：</p><ul><li>设置钩子函数，在命令执行前、后执行某些操作；</li><li>生成 Markdown/ReStructed Text/Man Page 格式的文档</li><li>等等</li></ul><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,65),g={href:"https://github.com/spf13/cobra",target:"_blank",rel:"noopener noreferrer"},f={href:"https://darjun.github.io/2020/01/17/godailylib/cobra/",target:"_blank",rel:"noopener noreferrer"},h=n("hr",{class:"footnotes-sep"},null,-1),q={class:"footnotes"},w={class:"footnotes-list"},y={id:"footnote1",class:"footnote-item"},C={href:"https://zh.wikipedia.org/wiki/%E5%8F%AF%E7%A7%BB%E6%A4%8D%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F%E6%8E%A5%E5%8F%A3",target:"_blank",rel:"noopener noreferrer"},x=n("strong",null,"可移植操作系统接口",-1),_=n("strong",null,"POSIX",-1),E={href:"https://zh.wikipedia.org/wiki/IEEE",target:"_blank",rel:"noopener noreferrer"},S={href:"https://zh.wikipedia.org/wiki/UNIX",target:"_blank",rel:"noopener noreferrer"},F={href:"https://zh.wikipedia.org/wiki/%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F",target:"_blank",rel:"noopener noreferrer"},P={href:"https://zh.wikipedia.org/wiki/API",target:"_blank",rel:"noopener noreferrer"},A={href:"https://zh.wikipedia.org/wiki/ISO",target:"_blank",rel:"noopener noreferrer"},I={href:"https://zh.wikipedia.org/wiki/IEC",target:"_blank",rel:"noopener noreferrer"},B=n("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1);function O(L,N){const a=c("ExternalLinkIcon");return p(),o("div",null,[u,r,n("p",null,[s("关于作者"),n("a",d,[s("spf13"),t(a)]),s("，这里多说两句。spf13 开源不少项目，而且他的开源项目质量都比较高。 相信使用过 vim 的都知道"),n("a",k,[s("spf13-vim"),t(a)]),s("，号称 vim 终极配置。 可以一键配置，对于我这样的懒人来说绝对是福音。他的"),n("a",v,[s("viper"),t(a)]),s("是一个完整的配置解决方案。 完美支持 JSON/TOML/YAML/HCL/envfile/Java properties 配置文件等格式，还有一些比较实用的特性，如配置热更新、多查找目录、配置保存等。 还有非常火的静态网站生成器"),n("a",m,[s("hugo"),t(a)]),s("也是他的作品。")]),b,n("ol",null,[n("li",null,[n("a",g,[s("cobra"),t(a)]),s(" gitHub repo")]),n("li",null,[n("a",f,[s("cobra"),t(a)]),s(" darjun blog")])]),h,n("section",q,[n("ol",w,[n("li",y,[n("p",null,[n("a",C,[x,t(a)]),s("（英语：Portable Operating System Interface，缩写为"),_,s("）是"),n("a",E,[s("IEEE"),t(a)]),s("为要在各种"),n("a",S,[s("UNIX"),t(a)]),n("a",F,[s("操作系统"),t(a)]),s("上运行软件，而定义"),n("a",P,[s("API"),t(a)]),s("的一系列互相关联的标准的总称，其正式称呼为IEEE Std 1003，而国际标准名称为"),n("a",A,[s("ISO"),t(a)]),s("/"),n("a",I,[s("IEC"),t(a)]),s(" 9945。 "),B])])])])])}const D=e(l,[["render",O],["__file","cobra.html.vue"]]);export{D as default};
