import{_ as e,Z as o,$ as c,a0 as n,a1 as s,a2 as t,a4 as p,H as l}from"./framework-d03928c9.js";const i={},u=p(`<h2 id="_5-1-异常传递" tabindex="-1"><a class="header-anchor" href="#_5-1-异常传递" aria-hidden="true">#</a> 5.1 异常传递</h2><p>出现异常通常表示系统进入了一个无法满足用户操作的状态，此时系统需要传达几个关键的信息：</p><ol><li><strong>发生了什么</strong> 包含对异常的描述；例如：磁盘已满，连接重置等</li><li><strong>发生在什么时间，什么位置</strong> 异常发生的完整<strong>调用栈</strong>信息以及异常<strong>发生的时间</strong></li><li><strong>对用户友好的信息</strong> 对发送给用户的信息进行自定义</li><li><strong>告诉用户如何获取更多信息</strong> 在发给用户的信息中应告知详细的异常信息在哪里可以获取</li></ol><p>异常可分为两类：</p><ol><li>Bug：未知的错误，没有预先定义的异常</li><li>已知异常：已预先定义的异常</li></ol><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code>
