import{_ as n,Z as s,$ as a,a3 as e}from"./framework-09afcf0b.js";const i={},t=e(`<h1 id="_13-2-运行时异常和-panic" tabindex="-1"><a class="header-anchor" href="#_13-2-运行时异常和-panic" aria-hidden="true">#</a> 13.2 运行时异常和 panic</h1><p>当触发运行时错误时，会触发 panic，抛出<code>runtime.Error</code>接口型的值。</p><p><code>panic()</code>可以直接从代码初始化，接受任意类型的参数（通常为字符串），在程序死亡时打印出来，Go 运行时负责终止程序并给出调试信息。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
