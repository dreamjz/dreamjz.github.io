import{_ as n,Z as s,$ as a,a4 as t}from"./framework-d03928c9.js";const p={},e=t(`<h1 id="_6-12-通过内存缓存提升性能" tabindex="-1"><a class="header-anchor" href="#_6-12-通过内存缓存提升性能" aria-hidden="true">#</a> 6.12 通过内存缓存提升性能</h1><p>通过在内存中缓存和重复利用相同的计算结果，称之为内存缓存。</p><p>以 fibonacci 数列为例，计算第n个数字需要前两个数字，而前两个数字已经计算过了，将其缓存在内存中可提升速度。</p><p><a href="path/06_12_fibonacci_memorization.go">06_12_fibonacci_memorization.go</a></p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">const</span> LIMIT <span class="token operator">=</span> <span class="token number">50</span>
