import{_ as c,Y as i,Z as l,$ as s,a0 as n,a1 as a,a4 as u,a2 as o,F as e}from"./framework-d955655f.js";const r={},d=s("h2",{id:"introduction-简介",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#introduction-简介","aria-hidden":"true"},"#"),n(" Introduction 简介")],-1),k=s("code",null,"fsnotify",-1),v=o(`<p><code>fsnotify</code>是一个基于Go的跨平台文件系统通知库（Cross-platform file system notifications for Go）</p><h2 id="quick-start-快速开始" tabindex="-1"><a class="header-anchor" href="#quick-start-快速开始" aria-hidden="true">#</a> Quick start 快速开始</h2><p>在go module中导入：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go get -u github.com/fsnotify/fsnotify latest
