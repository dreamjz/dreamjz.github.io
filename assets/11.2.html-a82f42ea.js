import{_ as n,Z as s,$ as a,a4 as e}from"./framework-d03928c9.js";const t={},i=e(`<h1 id="_11-2-接口嵌套接口" tabindex="-1"><a class="header-anchor" href="#_11-2-接口嵌套接口" aria-hidden="true">#</a> 11.2 接口嵌套接口</h1><p>一个接口可以包含一个或多个其他的接口，这相当于直接将这些内嵌接口的方法列举在外层接口中一样。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> ReadWrite <span class="token keyword">interface</span> <span class="token punctuation">{</span>
