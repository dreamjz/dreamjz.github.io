import{_ as n,Z as s,$ as a,a4 as e}from"./framework-d03928c9.js";const t={},p=e(`<h1 id="_5-5-break-和-contiue" tabindex="-1"><a class="header-anchor" href="#_5-5-break-和-contiue" aria-hidden="true">#</a> 5.5 break 和 contiue</h1><h2 id="break" tabindex="-1"><a class="header-anchor" href="#break" aria-hidden="true">#</a> break</h2><p>可用于跳出循环</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">for</span> <span class="token punctuation">{</span>
