import{_ as n,Z as s,$ as a,a3 as t}from"./framework-dee406ed.js";const e={},c=t(`<h1 id="_13-3-从-panic-中恢复-recover" tabindex="-1"><a class="header-anchor" href="#_13-3-从-panic-中恢复-recover" aria-hidden="true">#</a> 13.3 从 panic 中恢复(recover)</h1><p><code>recover()</code> 用于从错误场景中恢复，让程序从 Panicking 中获得控制权，停止终止过程恢复正常执行。</p><p><code>recover()</code>只能在<code>defer</code>修饰的函数中使用，用于取得<code>panic()</code>调用中传递的错误值；若正常执行，<code>recover()</code>返回<code>nil</code>。</p><p><strong><code>panic()</code> 会导致栈被展开知道<code>defer</code> 修饰的<code>recover()</code>被调用或者程序终止</strong>。</p><p><a href="path/panic_recover.go">panic_recover.go</a></p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> chapter_13
