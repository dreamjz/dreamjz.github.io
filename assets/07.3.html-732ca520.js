import{_ as n,Z as s,$ as a,a3 as e}from"./framework-09afcf0b.js";const t={},p=e(`<h1 id="_7-3-for-range" tabindex="-1"><a class="header-anchor" href="#_7-3-for-range" aria-hidden="true">#</a> 7.3 for-range</h1><p>可用<code>for-range</code>遍历切片和数组</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">for</span> index<span class="token punctuation">,</span> value <span class="token operator">:=</span> <span class="token keyword">range</span> slice <span class="token punctuation">{</span>
