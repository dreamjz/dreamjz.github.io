import{_ as n,Z as s,$ as a,a4 as e}from"./framework-d03928c9.js";const t={},p=e(`<h1 id="_11-1-接口" tabindex="-1"><a class="header-anchor" href="#_11-1-接口" aria-hidden="true">#</a> 11.1 接口</h1><p>接口定义一组方法，方法不含实现代码。</p><p>接口中不能有变量。</p><p>定义接口：</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Namer <span class="token keyword">interface</span> <span class="token punctuation">{</span>
