import{_ as t,Z as p,$ as e,a0 as n,a1 as o,a2 as c,a3 as s,H as l}from"./framework-09afcf0b.js";const i={},u=s(`<h2 id="_4-1-for-select" tabindex="-1"><a class="header-anchor" href="#_4-1-for-select" aria-hidden="true">#</a> 4.1 for-select</h2><p><code>for-select</code>模式常见的有两种：</p><ol><li>向channel中发送迭代变量</li><li>循环等待停止</li></ol><h3 id="向channel中发送迭代变量" tabindex="-1"><a class="header-anchor" href="#向channel中发送迭代变量" aria-hidden="true">#</a> 向channel中发送迭代变量</h3><p>将迭代的内容持续的发送到通道中。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code>strs <span class="token operator">:=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token builtin">string</span><span class="token punctuation">{</span><span class="token string">&quot;a&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;b&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;c&quot;</span><span class="token punctuation">}</span>
