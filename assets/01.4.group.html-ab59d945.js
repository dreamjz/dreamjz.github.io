import{_ as p,Z as o,$ as c,a0 as n,a1 as a,a2 as t,a3 as e,H as i}from"./framework-09afcf0b.js";const u={},l=e('<h2 id="_1-路由分组" tabindex="-1"><a class="header-anchor" href="#_1-路由分组" aria-hidden="true">#</a> 1. 路由分组</h2><p>分组控制(Group Control)是 Web 框架应提供的基础功能之一。</p><p>若不进行路由分组，那么就需要针对每一个路由分别进行设置和操作。</p><p>对路由进行分组的好处：</p><ol><li>统一管理同一组的路由</li><li>实现路由组嵌套，不同的子路由可以使用单独的中间件，也可以共享父路由的中间件</li></ol><p>通过分组和中间件的组合，提高了系统的可扩展性。</p><h2 id="_2-实现" tabindex="-1"><a class="header-anchor" href="#_2-实现" aria-hidden="true">#</a> 2. 实现</h2>',7),r={href:"https://github.com/dreamjz/golang-notes/tree/main/books/7-days-golang/day4-router-group",target:"_blank",rel:"noopener noreferrer"},d=e(`<p>当前项目结构：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>DAY4-ROUTER-GROUP
│  go.mod
│  go.work
│  main.go
│
