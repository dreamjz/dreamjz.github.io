import{_ as n,Z as s,$ as a,a3 as t}from"./framework-dee406ed.js";const e={},p=t(`<h1 id="_14-8-惰性生成器" tabindex="-1"><a class="header-anchor" href="#_14-8-惰性生成器" aria-hidden="true">#</a> 14.8 惰性生成器</h1><h2 id="_14-8-1-生成器" tabindex="-1"><a class="header-anchor" href="#_14-8-1-生成器" aria-hidden="true">#</a> 14.8.1 生成器</h2><p>指的是被调用时返回序列中的下一个值的函数：</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code>    <span class="token function">generateInteger</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=</span><span class="token operator">&gt;</span> <span class="token number">0</span>
