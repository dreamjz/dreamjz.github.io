import{_ as e,Y as o,Z as p,$ as n,a0 as s,a1 as t,a2 as c,F as i}from"./framework-d955655f.js";const l={},u=c(`<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2><p><code>go-homedir</code>顾名思义用来获取用户的主目录。实际上使用<code>os/user</code>也可以获取这个信息</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
