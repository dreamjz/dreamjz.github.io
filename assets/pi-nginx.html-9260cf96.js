import{_ as r,Y as t,Z as d,$ as n,a0 as e,a1 as i,a4 as c,a2 as a,F as l}from"./framework-d955655f.js";const v={},u=a(`<p>入手了一个树莓派4B，想要将其变成小型服务器，同时也把自己的博客部署上去,环境：</p><ul><li>Raspberry Pi : 4B+/8G</li><li>OS: Raspios-64bit</li><li>Nginx</li></ul><h2 id="配置静态ip" tabindex="-1"><a class="header-anchor" href="#配置静态ip" aria-hidden="true">#</a> 配置静态IP</h2><p>由于树莓派连接家里的路由器，默认使用DHCP<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup></p><p>要做为服务器的话，设置静态方便配置连接</p><p>修改<code>cat /etc/dhcpcd.conf</code>:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>interface wlan0
