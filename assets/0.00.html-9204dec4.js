import{_ as a,Y as d,Z as r,$ as i,a0 as e,a1 as l,a2 as s,F as v}from"./framework-d955655f.js";const c={},t=s('<p>在学习了后端的 Gin 和 Gorm 和前端的 Vuex 和 Vue Router之后，是时候实践和巩固已学习的知识点了</p><p>接下来将创建一个简单的 blog application，将实现以下功能：</p><ul><li>登录验证</li><li>路由鉴权</li><li>文章的添加，删除，修改和查询</li><li>Markdown 格式文章的展示</li></ul><p>开发环境：</p><ul><li>OS: 5.10.79-1-MANJARO</li><li>Database: 10.6.5-MariaDB Arch Linux</li><li>Golang: 1.17</li><li>Node: 16.11.1</li></ul><h2 id="_1-frontend" tabindex="-1"><a class="header-anchor" href="#_1-frontend" aria-hidden="true">#</a> 1. Frontend</h2>',6),o={href:"https://github.com/PanJiaChen",target:"_blank",rel:"noopener noreferrer"},u={href:"https://github.com/PanJiaChen/vue-admin-template",target:"_blank",rel:"noopener noreferrer"},m=s(`<p><strong>目录结构</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── build                      # 构建相关
├── mock                       # 项目mock 模拟数据
├── plop-templates             # 基本模板
├── public                     # 静态资源
