import{_ as n,Z as s,$ as a,a3 as t}from"./framework-09afcf0b.js";const e={},p=t(`<h1 id="_10-4-带标签的结构体" tabindex="-1"><a class="header-anchor" href="#_10-4-带标签的结构体" aria-hidden="true">#</a> 10.4 带标签的结构体</h1><p><strong>标签(tag)</strong>： 附属于字段的字符串，只能通过<code>reflect</code>包访问。</p><p>​ <a href="path/10_4_struct_tag.go">10_4_struct_tag.go</a></p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> TagType <span class="token keyword">struct</span> <span class="token punctuation">{</span>
