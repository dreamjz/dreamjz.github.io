import{_ as c,Z as i,$ as l,a0 as s,a1 as n,a2 as a,a5 as u,a3 as o,H as e}from"./framework-09afcf0b.js";const r={},d=s("h2",{id:"introduction-简介",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#introduction-简介","aria-hidden":"true"},"#"),n(" Introduction 简介")],-1),k=s("code",null,"fsnotify",-1),v=o(`<p><code>fsnotify</code>是一个基于Go的跨平台文件系统通知库（Cross-platform file system notifications for Go）</p><h2 id="quick-start-快速开始" tabindex="-1"><a class="header-anchor" href="#quick-start-快速开始" aria-hidden="true">#</a> Quick start 快速开始</h2><p>在go module中导入：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>go get -u github.com/fsnotify/fsnotify latest
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="application-应用" tabindex="-1"><a class="header-anchor" href="#application-应用" aria-hidden="true">#</a> Application 应用</h2>`,24),m=s("code",null,"fsnotify",-1),f={href:"https://pkg.go.dev/github.com/fsnotify/fsnotify@v1.5.1",target:"_blank",rel:"noopener noreferrer"},b=o(`<p>这里看下<code>viper.WatchConfig</code>是是如何使用<code>fsnotify</code> 的:</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// viper.go</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用流程类似：</p><ul><li>使用<code>NewWatcher</code>创建监听器</li><li><code>v.getConfigFile</code>方法获取配置文件路径，并提取文件名，目录，链接指向路径（若配置文件是一个link）</li><li>使用<code>watcher.Add</code>监听配置目录，并启用新的goroutine处理事件</li></ul><p><code>WatchConfig</code>不能阻塞主goroutine,故创建监听器是在新的goroutine中进行；方法中由两个<code>sync.WaitGroup</code>变量，<code>initWG</code>保证监听器的初始化,<code>eventsWG</code>在events通道关闭，配置删除或遇到错误时退出循环</p><p>之后就是核心代码：</p><ul><li>事件触发后，判断是否是关于配置文件的事件且仅处理<code>Create</code>和<code>Write</code>事件</li><li>调用<code>v.ReadInConfig</code>加载配置(配置文件的link发生改变也会触发重新加载)</li><li>若注册事件回调函数，则以事件为参数调用回调参数</li></ul><h2 id="conclusion-总结" tabindex="-1"><a class="header-anchor" href="#conclusion-总结" aria-hidden="true">#</a> Conclusion 总结</h2><p><code>fsnotify</code>的接口非常简单直接，所有系统相关的复杂性都被封装起来了。这也是我们平时设计模块和接口时可以参考的案例</p><h2 id="reference-参考" tabindex="-1"><a class="header-anchor" href="#reference-参考" aria-hidden="true">#</a> Reference 参考</h2>`,10),g={href:"https://pkg.go.dev/github.com/fsnotify/fsnotify@v1.5.1",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/fsnotify/fsnotify",target:"_blank",rel:"noopener noreferrer"},y={href:"https://darjun.github.io/2020/01/19/godailylib/fsnotify/",target:"_blank",rel:"noopener noreferrer"};function w(_,C){const p=e("RouterLink"),t=e("ExternalLinkIcon");return i(),l("div",null,[d,s("p",null,[n("在上一篇介绍"),a(p,{to:"/zh/golang/golang-daily-lib/viper.html"},{default:u(()=>[n("viper")]),_:1}),n("的文章中，viper内部使用了"),k,n("库实现监听文件修改并自动重新加载")]),v,s("p",null,[m,n("的应用比较广泛，在"),s("a",f,[n("godoc"),a(t)]),n("页面上可以看到其被超过3000个项目引用")]),b,s("ol",null,[s("li",null,[s("a",g,[n("fsnotify"),a(t)]),n(" godocs")]),s("li",null,[s("a",h,[n("fsnotify"),a(t)]),n(" github-repo")]),s("li",null,[s("a",y,[n("fsnotify"),a(t)]),n(" darjun/blog")])])])}const x=c(r,[["render",w],["__file","fsnotify.html.vue"]]);export{x as default};
