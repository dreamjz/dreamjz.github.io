import{_ as n,Z as s,$ as a,a3 as e}from"./framework-09afcf0b.js";const t={},i=e(`<h1 id="_14-5-通道、超时和计时器-ticker" tabindex="-1"><a class="header-anchor" href="#_14-5-通道、超时和计时器-ticker" aria-hidden="true">#</a> 14.5 通道、超时和计时器(Ticker)</h1><h2 id="_14-5-1-计时器" tabindex="-1"><a class="header-anchor" href="#_14-5-1-计时器" aria-hidden="true">#</a> 14.5.1 计时器</h2><p><code>time.Ticker</code>, 可以指定时间间隔重复向通道<code>c</code>发送时间值：</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Ticker <span class="token keyword">struct</span> <span class="token punctuation">{</span>
