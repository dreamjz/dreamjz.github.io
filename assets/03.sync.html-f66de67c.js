import{_ as a,Z as t,$ as p,a0 as n,a1 as e,a2 as o,a4 as c,H as i}from"./framework-d03928c9.js";const l={},u=c(`<h2 id="_3-1-waitgroup" tabindex="-1"><a class="header-anchor" href="#_3-1-waitgroup" aria-hidden="true">#</a> 3.1 WaitGroup</h2><p><code>WaitGroup</code>可以视作并发安全的计数器：</p><ul><li><code>Add()</code>：添加计数次数</li><li><code>Done()</code>：计数器减一</li><li><code>Wait()</code>：阻塞直到计数器归零</li></ul><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">func</span> <span class="token function">wg</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
